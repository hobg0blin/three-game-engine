...
export default function createGeometries( tiling ) {
  ...
  bufferGeometryA.setAttribute( 'position', new THREE.Float32BufferAttribute( positionsA, 3 ) );
  bufferGeometryA.setAttribute( 'uv', new THREE.Float32BufferAttribute( uvsA, 2 ) );

  bufferGeometryB.setAttribute( 'position', new THREE.Float32BufferAttribute( positionsB, 3 ) );
  bufferGeometryB.setAttribute( 'uv', new THREE.Float32BufferAttribute( uvsB, 2 ) );
